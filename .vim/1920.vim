...
set shortmess=aoO
badd +0 ~/mydocs/spacer.txt
silent! argdel *
edit ~/mydocs/spacer.txt
...
exe 'vert 1resize ' . ((&columns * 80 + 135) / 271)
exe '2resize ' . ((&lines * 34 + 36) / 72)
exe 'vert 2resize ' . ((&columns * 80 + 135) / 271)
exe '3resize ' . ((&lines * 35 + 36) / 72)
exe 'vert 3resize ' . ((&columns * 161 + 135) / 271)
exe 'vert 4resize ' . ((&columns * 109 + 135) / 271)
argglobal
setlocal keymap=
setlocal noarabic
